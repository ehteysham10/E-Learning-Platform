...
//   if (exists && exists.emailVerified) return res.status(400).json({ message: "Email already registered" });
...
//   if (!user.password) return res.status(400).json({ message: "OAuth users cannot update password" });
